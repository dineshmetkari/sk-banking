...
/*import jjsan.eu.skbanking.R.drawable;
...
public abstract class BankdroidWidgetProvider extends AppWidgetProvider {
    ...
    private final static String ACTION_WIDGET_BLUR = "jjsan.eu.skbanking.action.WIDGET_BLUR";
    private final static String ACTION_WIDGET_UNBLUR = "jjsan.eu.skbanking.action.WIDGET_UNBLUR";
    ...
    static RemoteViews buildAppWidget(Context context, AppWidgetManager appWidgetManager,
		...
		Account account = BankFactory.accountFromDb(context, bankId + "_" + accountId, false, false);
		if (account == null) {
